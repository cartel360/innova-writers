...
image: assets/images/hashing.jpg
tags:  [hashing, security, passwords, cryptography, .NET]
description: Hashing is basically turning your password into a secret code that no one (not even you) can reverse. When someone signs up, you don’t store their actual password. Instead, you store this code, called a **hash**. Later, when they log in, you hash the password they enter and check if it matches the stored hash. If it does, they’re in.
---
